...
// Loop through the table and set the image tags
for (var i = 1; i <= n; ++i) {
...
{/* <picture>
    ...
    <img alt="Pittsburgh Steelers logo" class="img-fluid" src="https://static.www.nfl.com/t_q-best/league/api/clubs/logos/PIT">
    </picture> */}